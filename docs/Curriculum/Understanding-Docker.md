...
For windows, see [this page]({% link docs/Technical/Setup Dev Tools/Windows/Installing-Docker.md %}).

For Linux, see [this page]({% link docs/Technical/Setup Dev Tools/Linux/DevContainer.md %}).
