---
title: Non-Programmer Friendly Zone
---
...
Before anything else, I recommend that you go straight to [Introduction to Programming]({% link docs/Non-Programmer Friendly Zone/Introduction-to-Programming.md %}) if you have minimal or no exposure to programming, OR if you want to find links for resources on learning how to program
