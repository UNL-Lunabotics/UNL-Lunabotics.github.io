...
In order to contribute, you should make a new branch, add your documentation, then you will need to make a pull request when you are done for your contribution to be included in the main branch.  
