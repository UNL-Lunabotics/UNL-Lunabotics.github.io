...
At its core, this repository uses Markdown, a mark-up language for documentation. This guide assumes *some* knowledge of Markdown. (**REWORD**) If you are unfamiliar, use this [Markdown guide](https://www.markdownguide.org/) as a reference.
